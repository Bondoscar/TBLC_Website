...
const Resources = () => {
  ...
  return (
    <div className="bg-black text-white">
      ...
      {/* Newsletters */}
      <section className="py-16 px-6 lg:px-10 border-t border-neutral-900">
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {newsletters.map((n, i) => (
              <a key={i} href={n.url} className="border border-neutral-800 px-5 py-4 flex items-center justify-between hover:bg-white hover:text-black transition-colors group">
      ...
      <section className="py-16 px-6 lg:px-10 border-t border-neutral-900">
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-neutral-800 p-8 card-hover">
