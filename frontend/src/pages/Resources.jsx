    ...
    <div className="bg-blue-950 text-white">
      ...
      <section className="py-16 px-6 lg:px-10">
        <div className="max-w-[900px] mx-auto">
          ...
          {subscribed ? (
            <div className="border border-blue-800 p-8 text-center">
      ...
      {/* Newsletters */}
      <section className="py-16 px-6 lg:px-10 border-t border-blue-900">
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {newsletters.map((n, i) => (
              <a key={i} href={n.url} className="border border-blue-800 px-5 py-4 flex items-center justify-between hover:bg-white hover:text-blue-950 transition-colors group">
      ...
      <section className="py-16 px-6 lg:px-10 border-t border-blue-900">
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-blue-800 p-8 card-hover">
