...
const MyCCC = () => {
  ...
  const submit = (e) => {
    ...
    setSubmitted(true);
    toast({ title: 'Thanks for your interest in myCCC!', description: 'We will be in touch soon.' });
  };
  ...
  return (
    <div className="bg-black text-white">
      <section className="pt-16 pb-10 px-6 lg:px-10 text-center border-b border-neutral-900">
        ...
        <h1 className="hero-title text-4xl md:text-6xl">myCCC</h1>
      </section>

      <section className="py-16 px-6 lg:px-10">
        <div className="max-w-[900px] mx-auto text-white/85 leading-relaxed">
          <p className="mb-5">
            Thank you for your interest in <span className="text-white">myCCC</span>! In our myCCC session we will talk about our church’s story thus far, how to grow in your personal relationship with Jesus, how to experience salvation and how you can get involved at CCC. Our desire is for Our Church to be Your Church.
          </p>
          ...
          <p className="text-white">Our upcoming myCCC classes will be on <span className="font-semibold">April 19, April 26, May 3 at 10am</span>.</p>
        </div>
      </section>

      <section className="pb-20 px-6 lg:px-10">
        <div className="max-w-[760px] mx-auto border border-neutral-800 p-8 md:p-10">
          <h2 className="section-title text-center mb-8">Register for myCCC</h2>
          {submitted ? (
            <div className="text-center">
              <CheckCircle2 size={40} className="mx-auto text-white mb-4" />
              <div className="serif-display text-2xl font-semibold">Thank you for your interest in myCCC!</div>
            ...
            <form onSubmit={submit} className="space-y-5">
              ...
              <div>
                <div className="text-xs tracking-[0.2em] text-white/70 mb-3">WILL SOMEONE BE JOINING YOU FOR myCCC?</div>
      ...
      <section className="relative w-full">
        <div className="relative h-[30vh] min-h-[220px]">
          <img src={bannerImage} alt="myCCC" className="absolute inset-0 w-full h-full object-cover" />
