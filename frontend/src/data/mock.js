// Mock data for Capital Community Church clone
...
export const upcomingEvents = [
  ...
  {
    id: 2,
    title: 'myCCC - A Small Group For New Believers',
...
export const ministries = [
  {
    id: 'kids',
    title: 'Kids',
    image: 'https://static.wixstatic.com/media/c1a9a3_dd54c8d3bffc4274be4fc48c0b4ee16e~mv2.png/v1/fill/w_304,h_112,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/2019-CCC-Kids.png',
  ...
  },
  {
    ...
    description: 'Capital Community Youth is a vibrant and growing department that provides powerful and Christ-centered ministry to youth from ages twelve and up. This ministry offers exciting activities, live music, missions opportunities, and special events throughout the year. Capital Community Youth service is held each Wednesday at 7:00pm.',
  },
  {
    id: 'seniors',
    title: 'Seniors',
  ...
  },
  {
    ...
    image: 'https://static.wixstatic.com/media/78447e_cf79aa78e9394d789cc69765f6e6ca6d~mv2.jpg/v1/crop/x_381,y_0,w_918,h_919/fill/w_330,h_330,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/CCC-October%2006%2C%202019-3068.jpg',
...
export const sermons = [
  ...
  { id: 7, title: 'There is Victory by the blood of Jesus Christ!', speaker: 'CCC', duration: '00:47', youtubeId: 'vKV-ZnqrubY' },
  { id: 8, title: 'He paid the price, for us!', speaker: 'CCC', duration: '00:53', youtubeId: 'DpUmzQaWf4M' },
  { id: 9, title: 'All my sins are washed away', speaker: 'CCC', duration: '00:54', youtubeId: 'uVPWdiwrMTI' },
];

export const aboutContent = {
  hero: 'Our church is your church.',
  intro: 'CCC is located on top of Baseball Hill in the historic community of Marysville, and we\'ve ministered to families in the greater Fredericton area for over sixty years. We are a progressive, visionary congregation with a passion for real spirituality, a love for family, a heart for community, and a zest for life.',
  mission: 'To know Christ and make Him known throughout Fredericton, New Brunswick, Canada, and around the world.',
...
export const churchInfo = {
  address: '29 Canada Street, Marysville, NB, Canada',
  phone: '(506) 472-1515',
  email: 'info@capitalcommunity.ca',
